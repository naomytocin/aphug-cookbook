      ...
      <div class="eb-garamond-norm flex h-screen items-center">
        <div class="m-20 flex">
          <div class="relative rounded-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-110 hover:translate-y-2 opacity-20 hover:opacity-100">
            ...
            />
            <div
              class="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300 ease-in-out transform hover:scale-110 hover:translate-y-2"
              //style={{ pointerEvents: "none" }}
            >
              <p class="zhi-mang-xing-regular text-2xl scale-500 text-gray-900">
                米
              </p>
            </div>
          </div>
